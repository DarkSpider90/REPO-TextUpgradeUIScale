...
namespace DSStatsUIFontMod
{
    ...
    public class StatsUIFontMod : BaseUnityPlugin
    {
        ...
        private void BindConfig()
        {
            ...
            ShrinkStep = Config.Bind("Text fitting", "ShrinkStep", 0.1f, new ConfigDescription("Text scale removed per shrink step. 0.1 means 10%.", new AcceptableValueRange<float>(0.01f, 0.5f)));
